...
public class ValidException extends RuntimeException {
    ...
    public ValidException(String errorCode, Object... errorParams) {
        this.errorCode = errorCode;
        this.errorParams = errorParams;
    }

    public ValidException(Throwable cause, String errorCode) {
        super(cause);
        this.errorCode = errorCode;
    }
    ...
    public ValidException put(String name, Object prop) {
        if (name != null) {
